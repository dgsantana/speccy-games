//! The Spectrum's ROM font, characters 32 to 127.
//!
//! Eight bytes a glyph, one bit a pixel, in the same order the ROM held them at
//! 15616. Every game prints with it, so it lives here rather than in any one
//! game's data.

/// Eight rows of pixels for each of the 96 printable characters.
